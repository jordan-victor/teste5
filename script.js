...
// ----------------------------- SCRIPT REFERENTE AO CARROSEL DE IMAGENS ----------------------------------
function carrosel(){
    var Carrosel = setInterval (()=>{
        ...
        if (numero == 1){
            imagemCorrente.setAttribute("src", "BURGER 1.jpg")
        }

        else if (numero == 2){
            imagemCorrente.setAttribute("src", "BURGER 2.jpg")
        }

        else if (numero == 3){
            imagemCorrente.setAttribute("src", "BURGER 3.jpg")
        }

        else if (numero == 4){
            imagemCorrente.setAttribute("src", "BURGER 4.jpg")
        }
        //Zerando o contador
        else if (numero > 4){
